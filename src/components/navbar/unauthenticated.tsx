    ...
    <nav className="flex items-center justify-between px-4 md:px-8 py-4 bg-[#E5E5E5] text-[#5D5D5D] font-semibold shadow relative z-50">
      <div className="flex items-center gap-6">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link to="/how-it-works" className="hover:text-red-500">How it Works</Link>
      ...
      <div className="flex items-center">
        <Link to="/login" className="hidden md:block">
          <button className="bg-red-500 text-white px-9 py-2 rounded-md hover:bg-red-600 transition font-bold">
            Sign In
          </button>
        </Link>
        <button
